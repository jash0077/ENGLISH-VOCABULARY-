...
type Mode = "dashboard" | "shelf" | "flashcards" | "quiz" | "tenses" | "shadowing" | "tenseQuiz" | "review";
...
export default function Home() {
  ...
  const filtered = useMemo(() => words.filter(w => (category === "All words" || w.cat === category) && (difficulty === "All" || (difficulty === "Easy" ? w.dif === 1 : difficulty === "Medium" ? w.dif === 2 : w.dif >= 3)) && (`${w.w} ${w.m} ${w.cat}`.toLowerCase().includes(query.toLowerCase()))), [words, category, difficulty, query]);
