...
const PRACTICE_PASSAGES = [...SHADOWING_PASSAGES, { id: "daily-fluency", speaker: "Vocab Studio", title: "Daily Fluency Collection", level: "Mixed", description: "One hundred short lines for daily rhythm practice.", sentences: SHADOWING_EXPANSION.map(item => item.text) }] as const;
